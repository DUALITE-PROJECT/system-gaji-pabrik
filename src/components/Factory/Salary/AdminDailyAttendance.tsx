...
import { AdminDailyAttendanceInput } from './AdminDailyAttendanceInput';
import { AdminDailyAttendanceList } from './AdminDailyAttendanceList';

export const AdminDailyAttendance: React.FC = () => {
  ...
  return (
    <div className="space-y-6 h-full flex flex-col font-sans">
      ...
      <div className="flex-1 min-h-0 animate-fadeIn">
        {activeSubTab === 'input' && <AdminDailyAttendanceInput />}
        {activeSubTab === 'hasil' && <AdminDailyAttendanceList />}
      </div>
    </div>
  );
};
