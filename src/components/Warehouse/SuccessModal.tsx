...
export const SuccessModal: React.FC<SuccessModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-4 animate-fadeIn">
      <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all scale-100 relative">
        ...
        <div className="p-8 text-center">
          ...
          <button
            onClick={onClose}
            className="w-full py-3.5 bg-erp-blue-600 hover:bg-erp-blue-700 text-white rounded-xl font-semibold shadow-lg shadow-blue-900/20 transition-all transform active:scale-[0.98]"
          >
            Selesai
          </button>
        </div>
