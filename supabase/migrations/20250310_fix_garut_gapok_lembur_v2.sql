-- =================================================================
-- GARUT AUTO-SYNC SYSTEM - REVISI V8.1 (FIX GAPOK FORMULA)
-- Update: Menggunakan Gaji Harian (bukan Gaji Pokok Bulanan) untuk pengali H
-- =================================================================
...
BEGIN
    ...
    -- E. Hitung Nominal Gaji (REVISI V8.1: USE GAJI_HARIAN)
    UPDATE public.total_gaji_pabrik_garut t
    SET
        gapok = COALESCE(
            (COALESCE(m.gaji_harian, 0) * COALESCE(t.h, 0)) +  -- FIX: Gaji Harian * H
...
BEGIN
    ...
    SET
        gapok = COALESCE(
            (COALESCE(NEW.gaji_harian, 0) * COALESCE(t.h, 0)) + -- FIX: Gaji Harian * H
