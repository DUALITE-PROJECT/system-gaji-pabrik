-- =================================================================
-- GARUT AUTO-SYNC SYSTEM - REVISI V9 (UANG MAKAN)
-- Update: Formula Uang Makan dengan Potongan Bertahap
-- =================================================================

-- 1. Helper Function: Hitung Potongan Bertahap
-- Pola: 10k, 22k, 36k, 52k... (Tambah 2k setiap step)
-- Rumus: 9000n + 1000n^2
...
BEGIN
    ...
    -- E. Hitung Nominal Gaji (REVISI V9: Uang Makan)
    UPDATE public.total_gaji_pabrik_garut t
    SET
        -- Gapok & Lembur (V8)
        gapok = COALESCE(
