/* 
  # FIX: IDEMPOTENT SECURITY & TABLE SETUP
  # Script ini aman dijalankan berkali-kali.
  # Jika policy sudah ada, akan dihapus dulu lalu dibuat ulang.
*/

-- 1. Buat Tabel Stock Opname Rak (Jika belum ada)
...
-- 2. SECURITY FIX: Enable RLS & Public Access (Idempotent)
