-- =================================================================
-- GARUT AUTO-SYNC SYSTEM (REAL-TIME) - REVISI V7 (FULL STREAK S, I, T)
-- Update: S_B, S_TB, I_B, I_TB, T_B, T_TB
-- Logic: 'M' dan 'TM' TIDAK memutus urutan S, I, maupun T
-- =================================================================
...
BEGIN
    ...
    -- D. CALCULATE STREAK S, I, T (Procedural Loop)
    FOR emp_rec IN SELECT id, kode, periode FROM public.total_gaji_pabrik_garut WHERE bulan = p_bulan LOOP
        ...
        LOOP
            ...
            ELSIF att_rec.kehadiran IN ('M', 'TM') THEN NULL; -- Ignore
            ELSE
